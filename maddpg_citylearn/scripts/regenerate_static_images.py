...
ax.bar(range(1, n_buildings+1), last_rewards, color=[cmap_viridis(x) for x in np.linspace(0.2, 0.8, n_buildings)], edgecolor='black')
...
colors_box = [cmap_blues(x) for x in np.linspace(0.3, 0.9, len(episodes))]
