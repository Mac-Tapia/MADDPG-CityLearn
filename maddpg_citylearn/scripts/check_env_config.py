...
comparisons = [
    ...
    ("Obs por agente", "38-52", "38-52 (padded)"),
    ("Acciones por agente", "4-6", "4-6 (padded)"),
    ("Reward function", "EV_Reward_Function", "EV_Reward_Function"),
    ("Episode length", "8760 steps", "8760 steps"),
    ("Gamma", "0.99", "0.95"),
    ("Tau", "0.005", "0.005"),
    ("Learning rate (actor)", "0.001", "0.0003"),
    ("Learning rate (critic)", "0.001", "0.001"),
    ("Batch size", "256", "512"),
    ("Buffer size", "100000", "200000"),
    ("Hidden dim", "[256, 256]", "[256, 256]"),
    ("Algoritmo base", "SAC", "DDPG"),
    ("Coordinación", "Regression+Sharing", "CTDE (centralized critic)"),
]
